...
import { DiagramEngine, LayoutEngine, classDiagramModule, diagramModule, dslModule } from "@hylimo/diagram";
...
const diagramEngine = new DiagramEngine(
    new Parser(false),
    new Interpreter([...defaultModules, diagramModule, dslModule, classDiagramModule], maxExecutionSteps),
    layoutEngine
);
